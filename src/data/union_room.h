...
ALIGNED(4) const u8 sText_PleaseStartOver[] = _("Hay que empezar de nuevo.");
ALIGNED(4) const u8 sText_WirelessSearchCanceled[] = _("  Se ha cancelado la Comunicación\nInalámbrica.");
ALIGNED(4) const u8 sText_AwaitingCommunucation2[] = _("Esperando respuesta del otro\nEntrenador."); // Unused
ALIGNED(4) const u8 sText_AwaitingCommunication[] = _("Para la opción\n{STR_VAR_1},\lfaltan jugadores por comunicarse.");
ALIGNED(4) const u8 sText_AwaitingLinkPressStart[] = _("Para la opción\n{STR_VAR_1},\lpulsa Start cuando estéis listos.");
...
const u8 sText_1PlayerNeeded[] = _("Falta 1\njugador.");
const u8 sText_2PlayersNeeded[] = _("Faltan 2\njugadores.");
const u8 sText_3PlayersNeeded[] = _("Faltan 3\njugadores.");
const u8 sText_4PlayersNeeded[] = _("Faltan 4\njugadores.");
const u8 sText_2PlayerMode[] = _("Modo de 2\njugadores");
const u8 sText_3PlayerMode[] = _("Modo de 3\njugadores");
const u8 sText_4PlayerMode[] = _("Modo de 4\njugadores");
const u8 sText_5PlayerMode[] = _("Modo de 5\njugadores");
...
ALIGNED(4) const u8 sText_BButtonCancel[] = _("{B_BUTTON}Cancelar");
ALIGNED(4) const u8 sJPText_SearchingForParticipants[] = _("ため\nさんかしゃ ぼしゅうちゅう です！"); // Unused, may have been cut off
ALIGNED(4) const u8 sText_PlayerContactedYouForXAccept[] = _("{STR_VAR_2} quiere\n{STR_VAR_1}.\l¿Aceptas?");
ALIGNED(4) const u8 sText_PlayerContactedYouShareX[] = _("{STR_VAR_2} se ha conectado.\n¿Compartes {STR_VAR_1}?");
ALIGNED(4) const u8 sText_PlayerContactedYouAddToMembers[] = _("{STR_VAR_2} se ha conectado.\n¿Añadir al grupo?");
ALIGNED(4) const u8 sText_AreTheseMembersOK[] = _("¿Está bien este grupo\n para {STR_VAR_1}?");
ALIGNED(4) const u8 sText_CancelModeWithTheseMembers[] = _("¿Cancelas\n{STR_VAR_1}\lpara este grupo?");
ALIGNED(4) const u8 sText_AnOKWasSentToPlayer[] = _("Se ha enviado el “OK”\na {STR_VAR_1}.");
ALIGNED(4) const u8 sText_OtherTrainerUnavailableNow[] = _("Parece que el otro Entrenador no\nestá disponible en este momento…\p");
ALIGNED(4) const u8 sText_CantTransmitTrainerTooFar[] = _("No puedes comunicarte con nadie\nque esté muy lejos.\p");
ALIGNED(4) const u8 sText_TrainersNotReadyYet[] = _("Hay Entrenadores que no están\nlistos todavía.\p");
...
ALIGNED(4) const u8 sText_ModeWithTheseMembersWillBeCanceled[] = _("Se cancelará\n{STR_VAR_1}\lpara este grupo.{PAUSE 60}");
ALIGNED(4) const u8 sText_MemberNoLongerAvailable[] = _("Hay un miembro del grupo que\nno puede seguir disponible.\p");
...
ALIGNED(4) const u8 sText_TrainerAppearsUnavailable[] = _("No parece que el otro ENTRENADOR\nesté disponible…\p");
ALIGNED(4) const u8 sText_PlayerSentBackOK[] = _("¡{STR_VAR_1} envió\ntambién un “OK”!");
ALIGNED(4) const u8 sText_PlayerOKdRegistration[] = _("{STR_VAR_1} te ha\nadmitido en el grupo.");
ALIGNED(4) const u8 sText_PlayerRepliedNo[] = _("{STR_VAR_1} responde\ncon un “No”…\p");
ALIGNED(4) const u8 sText_AwaitingOtherMembers[] = _("Para la opción\n{STR_VAR_1}\lfaltan jugadores.");
ALIGNED(4) const u8 sText_QuitBeingMember[] = _("¿Te sales del grupo?");
ALIGNED(4) const u8 sText_StoppedBeingMember[] = _("Ya no eres del grupo.\p");
...
ALIGNED(4) const u8 sText_WirelessLinkEstablished[] = _("Se ha establecido la Comunicación\nInalámbrica.");
ALIGNED(4) const u8 sText_WirelessLinkDropped[] = _("Se ha cortado la Comunicación\nInalámbrica.");
ALIGNED(4) const u8 sText_LinkWithFriendDropped[] = _("Se ha perdido la comunicación\ncon tu amigo…");
ALIGNED(4) const u8 sText_PlayerRepliedNo2[] = _("{STR_VAR_1} contesta\nque “No”…");
...
ALIGNED(4) const u8 sText_DoYouWantXMode[] = _("¿Eliges {STR_VAR_2}?");
ALIGNED(4) const u8 sText_DoYouWantXMode2[] = _("¿Eliges {STR_VAR_2}?");
...
ALIGNED(4) const u8 sText_CommunicatingPleaseWait[] = _("Comunicando…\nUn momento."); // Unused
ALIGNED(4) const u8 sText_AwaitingPlayersResponseAboutTrade[] = _("Esperando la respuesta de {STR_VAR_1}\npara el intercambio…");
ALIGNED(4) const u8 sText_Communicating[] = _("Comunicando{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.\n{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.");
ALIGNED(4) const u8 sText_CommunicatingWithPlayer[] = _("Comunicando con {STR_VAR_1}{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.\n{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.");
ALIGNED(4) const u8 sText_PleaseWaitAWhile[] = _("PUn momento{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.\n{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.");
...
ALIGNED(4) const u8 sText_HiDoSomethingMale[] = _("¡Hola! ¿Querías algo?");
ALIGNED(4) const u8 sText_HiDoSomethingFemale[] = _("¿Qué tal? ¿Quieres algo?");
ALIGNED(4) const u8 sText_HiDoSomethingAgainMale[] = _("{STR_VAR_1}: ¡Anda,\ncoincidimos de nuevo! ¿Y bien?");
ALIGNED(4) const u8 sText_HiDoSomethingAgainFemale[] = _("{STR_VAR_1}: ¡Eh, {PLAYER}!\n¿Qué te gustaría hacer?");
...
ALIGNED(4) const u8 sText_DoSomethingMale[] = _("¿Quieres hacer algo?");
ALIGNED(4) const u8 sText_DoSomethingFemale[] = _("¿Te gustaría hacer algo?");
ALIGNED(4) const u8 sText_DoSomethingAgainMale[] = _("{STR_VAR_1}: ¿Qué\nte apetecería hacer?");
ALIGNED(4) const u8 sText_DoSomethingAgainFemale[] = _("{STR_VAR_1}: ¿Quieres hacer algo más?"); // Unused
...
ALIGNED(4) const u8 sText_SomebodyHasContactedYou[] = _("Se están comunicando contigo.{PAUSE 60}");
ALIGNED(4) const u8 sText_PlayerHasContactedYou[] = _("{STR_VAR_1} está\nen conexión contigo.{PAUSE 60}");
...
ALIGNED(4) const u8 sText_AwaitingResponseFromTrainer[] = _("Esperando respuesta del otro\nEntrenador…");
...
ALIGNED(4) const u8 sText_ShowTrainerCard[] = _("El otro Entrenador te ha mostrado\nsu Ficha de Entrenador.\p¿Quieres enseñarle la tuya?");
ALIGNED(4) const u8 sText_BattleChallenge[] = _("El otro Entrenador te reta\na luchar.\p¿Aceptas el desafío?");
ALIGNED(4) const u8 sText_ChatInvitation[] = _("El otro Entrenador te invita\na chatear.\p¿Te apetece chatear un rato?");
ALIGNED(4) const u8 sText_OfferToTradeMon[] = _("Te proponen cambiar tu {DYNAMIC 1}\nde nivel{DYNAMIC 0}\ppor {DYNAMIC 3},\nde nivel {DYNAMIC 2}.\p¿Te parece buen trato?");
ALIGNED(4) const u8 sText_OfferToTradeEgg[] = _("Hay alguien que quiere el\nHuevo que tienes registrado.\l¿Se lo das?");
ALIGNED(4) const u8 sText_ChatDropped[] = _("Se ha interrumpido la comunicación.\p");
ALIGNED(4) const u8 sText_OfferDeclined1[] = _("Has decidido que no.\p");
ALIGNED(4) const u8 sText_OfferDeclined2[] = _("Has decidido que no.\p");
ALIGNED(4) const u8 sText_ChatEnded[] = _("La comunicación se ha finalizado.\p");
...
ALIGNED(4) const u8 sText_JoinChatMale[] = _("¡Eh, hola! ¡Estamos chateando!\n¿Te apuntas?");
ALIGNED(4) const u8 sText_PlayerJoinChatMale[] = _("{STR_VAR_1}: ¡Eh, {PLAYER}!\n¡Estamos chateando!\l¿Te apuntas?");
ALIGNED(4) const u8 sText_JoinChatFemale[] = _("¡Anda, hola! ¡Estamos chateando!\n¿Te apuntas?");
...
ALIGNED(4) const u8 sText_TrainerAppearsBusy[] = _("(?)… Parece que el Entrenador\nestá comunicando…\p");
ALIGNED(4) const u8 sText_WaitForBattleMale[] = _("Quieres luchar, ¿eh?\nVale, pero dame un poco de tiempo.");
ALIGNED(4) const u8 sText_WaitForChatMale[] = _("¿Quieres chatear?\nGenial, pero espera un momento.");
ALIGNED(4) const u8 sText_ShowTrainerCardMale[] = _("¿Te gusta mi Ficha de Entrenador?");
ALIGNED(4) const u8 sText_WaitForBattleFemale[] = _("¿Un combate? ¡Hecho!\nDeja solo que me prepare.");
ALIGNED(4) const u8 sText_WaitForChatFemale[] = _("¿Chatear? ¡Por mí, perfecto!\nDame solo un segundo.");
ALIGNED(4) const u8 sText_ShowTrainerCardFemale[] = _("Mira, te dejo que veas mi Ficha de Entrenador.");
...
ALIGNED(4) const u8 sText_WaitForChatMale2[] = _("¿Quieres chatear?\nGenial, pero espera un momento."); // Unused
ALIGNED(4) const u8 sText_DoneWaitingBattleMale[] = _("¡Gracias por esperar!\n¡Empecemos el combate!{PAUSE 60}");
ALIGNED(4) const u8 sText_DoneWaitingChatMale[] = _("¡Bueno, a chatear se ha dicho!{PAUSE 60}");
ALIGNED(4) const u8 sText_DoneWaitingBattleFemale[] = _("Perdona que te haya hecho\nesperar. ¡Ya estoy!{PAUSE 60}");
ALIGNED(4) const u8 sText_DoneWaitingChatFemale[] = _("Perdona que te haya hecho\nesperar. ¡A chatear!{PAUSE 60}");
ALIGNED(4) const u8 sText_TradeWillBeStarted[] = _("El intercambio va a comenzar.{PAUSE 60}");
ALIGNED(4) const u8 sText_BattleWillBeStarted[] = _("El combate va a comenzar.{PAUSE 60}");
ALIGNED(4) const u8 sText_EnteringChat[] = _("Entrando en el chat…{PAUSE 60}");
...
ALIGNED(4) const u8 sText_BattleDeclinedMale[] = _("Lo siento, pero mis Pokémon\nno se encuentran muy allá…\lDejémoslo para otra ocasión.\p");
ALIGNED(4) const u8 sText_BattleDeclinedFemale[] = _("No sabes cómo lo siento, pero mis\nPokémon no se encuentran bien…\lYa lucharemos en otro momento.\p");
...
ALIGNED(4) const u8 sText_ShowTrainerCardDeclinedMale[] = _("¿Mmm? ¿Dónde habré puesto\nmi Ficha de Entrenador?…\l¡Bueno, otra vez será!\p");
ALIGNED(4) const u8 sText_ShowTrainerCardDeclinedFemale[] = _("Eh…, no sé dónde he metido\nmi Ficha de Entrenador…\l¡Te la enseñaré en otra ocasión!\p");
...
ALIGNED(4) const u8 sText_IfYouWantToDoSomethingMale[] = _("Cuando quieras que hagamos algo,\n¡ya sabes dónde estoy!\p");
ALIGNED(4) const u8 sText_IfYouWantToDoSomethingFemale[] = _("Cuando quieras que hagamos algo,\nme lo dices, ¿eh?\p");
...
ALIGNED(4) const u8 sText_TrainerBattleBusy[] = _("¡Anda, si yo tenía que hacer\nun montón de cosas!\lOtra vez será, ¡lo siento!\p");
ALIGNED(4) const u8 sText_NeedTwoMonsOfLevel30OrLower1[] = _("Para luchar, necesitas dos Pokémon\nde nivel inferior a 30.\p");
ALIGNED(4) const u8 sText_NeedTwoMonsOfLevel30OrLower2[] = _("Si quieres luchar, necesitas dos\nPokémon de nivel inferior a 30.\p");

ALIGNED(4) const u8 sText_DeclineChatMale[] = _("Bueno, hasta la próxima.\p");
...
ALIGNED(4) const u8 sText_ChatDeclinedMale[] = _("Lo siento, ahora mismo no me\nviene bien.\lYa chatearemos en otro momento.\p");
ALIGNED(4) const u8 sText_ChatDeclinedFemale[] = _("Lo siento, ahora tengo mucho\nque hacer.\lYa chatearemos en otra ocasión.\p");
...
ALIGNED(4) const u8 sText_YoureToughMale[] = _("¡Guauuu!\n¡Sí que sois fuertes!\p");
ALIGNED(4) const u8 sText_UsedGoodMoveMale[] = _("¡Qué movimiento tan genial!\n¡Qué estrategia tan buena!\p");
ALIGNED(4) const u8 sText_BattleSurpriseMale[] = _("¡Qué pasada!\n¡Alucinante!\p");
ALIGNED(4) const u8 sText_SwitchedMonsMale[] = _("¿Pero cómo se puede usar a\nese Pokémon en una situación así?\p");
ALIGNED(4) const u8 sText_YoureToughFemale[] = _("Ese Pokémon sí que está bien\nentrenado…\p");
ALIGNED(4) const u8 sText_UsedGoodMoveFemale[] = _("¡Eso es! ¡Ése es el movimiento\nque hay que usar aquí!\p");
ALIGNED(4) const u8 sText_BattleSurpriseFemale[] = _("¡Es impresionante!\n¿Pero cómo se puede luchar así?\p");
ALIGNED(4) const u8 sText_SwitchedMonsFemale[] = _("¡No se puede cambiar de Pokémon\nen un momento mejor!\p");
...
ALIGNED(4) const u8 sText_LearnedSomethingMale[] = _("¡Hay cosas que se aprenden\ndesde pequeño!\p");
ALIGNED(4) const u8 sText_ThatsFunnyMale[] = _("¡Parad ya, que me parto de risa\n:-D!\p");
ALIGNED(4) const u8 sText_RandomChatMale1[] = _("Anda, qué curioso…\p");
ALIGNED(4) const u8 sText_RandomChatMale2[] = _("Mmmm… ¿Cómo?\n¿He entendido bien?\p");
ALIGNED(4) const u8 sText_LearnedSomethingFemale[] = _("Anda…\nNo tenía ni idea…\p");
ALIGNED(4) const u8 sText_ThatsFunnyFemale[] = _("¿De qué va la cosa?\p");
ALIGNED(4) const u8 sText_RandomChatFemale1[] = _("¡Eso mismo digo yo!\p");
ALIGNED(4) const u8 sText_RandomChatFemale2[] = _("Eh…\n¡Así es!\p");
...
ALIGNED(4) const u8 sText_ShowedTrainerCardMale1[] = _("Mira mi Ficha de Entrenador.\p");
ALIGNED(4) const u8 sText_ShowedTrainerCardMale2[] = _("Espero que nos conozcamos mejor.\p");
ALIGNED(4) const u8 sText_ShowedTrainerCardFemale1[] = _("Está bien enseñarse las Fichas\nde Entrenador. para conocerse.\p");
ALIGNED(4) const u8 sText_ShowedTrainerCardFemale2[] = _("Me alegro de conocerte.\n¡Espero que tú también!\p");
...
ALIGNED(4) const u8 sText_MaleTraded1[] = _("¡Yuuuujuu!\n¡Siempre he querido este Pokémon!\p");
ALIGNED(4) const u8 sText_MaleTraded2[] = _("¡Por fin! ¡Menos mal que se pueden\nconseguir Pokémon por intercambio!\p");
ALIGNED(4) const u8 sText_FemaleTraded1[] = _("¡Estoy intercambiando Pokémon!\p");
ALIGNED(4) const u8 sText_FemaleTraded2[] = _("¡Qué ganas de tener ese Pokémon!\p");
...
ALIGNED(4) const u8 sText_ChooseRequestedMonType[] = _("Elige el tipo de Pokémon que\nte gustaría recibir.\n");
ALIGNED(4) const u8 sText_WhichMonWillYouOffer[] = _("¿A qué miembro de tu equipo\nPokémon ofreces en el intercambio?\p");
ALIGNED(4) const u8 sText_RegistrationCanceled[] = _("Se ha cancelado el registro.\p");
ALIGNED(4) const u8 sText_RegistraionCompleted[] = _("Se ha finalizado el registro.\p");
ALIGNED(4) const u8 sText_TradeCanceled[] = _("Se ha cancelado el intercambio.\p");
ALIGNED(4) const u8 sText_CancelRegistrationOfMon[] = _("¿Cancelas el registro\nde tu {STR_VAR_1} de nivel {STR_VAR_2}?");
ALIGNED(4) const u8 sText_CancelRegistrationOfEgg[] = _("¿Cancelas el registro\nde tu Huevo?");
ALIGNED(4) const u8 sText_RegistrationCanceled2[] = _("Se ha cancelado el registro.\p");
...
ALIGNED(4) const u8 sText_AskTrainerToMakeTrade[] = _("¿Quieres preguntarle a {STR_VAR_1}\nsi quiere realizar un intercambio?");
...
ALIGNED(4) const u8 sText_DontHaveTypeTrainerWants[] = _("{STR_VAR_1} quiere un\nPokémon de tipo {STR_VAR_2}\ly no tienes…\p");
ALIGNED(4) const u8 sText_DontHaveEggTrainerWants[] = _("{STR_VAR_1} quiere un Huevo,\ny tú no tienes…\p");
ALIGNED(4) const u8 sText_PlayerCantTradeForYourMon[] = _("Ahora mismo, {STR_VAR_1} no\npuede ofrecerte nada\lpor tu Pokémon.\p");
ALIGNED(4) const u8 sText_CantTradeForPartnersMon[] = _("Ahora mismo, no puedes hacer\nningún intercambio por el\lPokémon de {STR_VAR_1}\p");
...
ALIGNED(4) const u8 sText_TradeOfferRejected[] = _("Tu oferta ha sido rechazada.\p");
ALIGNED(4) const u8 sText_EggTrade[] = _("Intercambio de Huevo");
ALIGNED(4) const u8 sText_ChooseJoinCancel[] = _("{DPAD_UPDOWN}Sel.  {A_BUTTON}Participar  {B_BUTTON}Atrás");
ALIGNED(4) const u8 sText_ChooseTrainer[] = _("Selecciona a un Entrenador.");
ALIGNED(4) const u8 sText_ChooseTrainerSingleBattle[] = _("Selecciona a un Entrenador\npara un Combate Individual.");
ALIGNED(4) const u8 sText_ChooseTrainerDoubleBattle[] = _("Selecciona a un Entrenador\npara un Combate Doble.");
ALIGNED(4) const u8 sText_ChooseLeaderMultiBattle[] = _("Selecciona al Líder para\nun Combate Múltiple.");
ALIGNED(4) const u8 sText_ChooseTrainerToTradeWith[] = _("Selecciona a un Entrenador\npara realizar un intercambio.");
ALIGNED(4) const u8 sText_ChooseTrainerToShareWonderCards[] = _("Selecciona al Entrenador que\ncomparte Tarjetas Misteriosas.");
ALIGNED(4) const u8 sText_ChooseTrainerToShareWonderNews[] = _("Selecciona al Entrenador que\ncomparte Noticias Misteriosas.");
ALIGNED(4) const u8 sText_ChooseLeaderPokemonJump[] = _("¡Salto Pokémon!\nSelecciona al Líder.");
ALIGNED(4) const u8 sText_ChooseLeaderBerryCrush[] = _("¡Machacabayas!\nSelecciona al Líder.");
ALIGNED(4) const u8 sText_ChooseLeaderBerryPicking[] = _("¡Dodrio a por Bayas!\nSelecciona al Líder.");
ALIGNED(4) const u8 sText_ChooseLeaderBerryBlender[] = _("¡Licuabayas!\nSelecciona al Líder.");
ALIGNED(4) const u8 sText_ChooseLeaderRecordCorner[] = _("¡Centro de Récords!\nSelecciona al Líder.");
...
ALIGNED(4) const u8 sText_ChooseLeaderBattleTowerLv50[] = _("¡Nv. 50 de Torre Batalla!\nSelecciona al Líder.");
ALIGNED(4) const u8 sText_ChooseLeaderBattleTowerOpenLv[] = _("¡Nv. Libre de Torre Batalla!\nSelecciona al Líder.");
...
ALIGNED(4) const u8 sText_SearchingForWirelessSystemWait[] = _("Buscando el sistema de\nComunicación Inalámbrica…");
...
ALIGNED(4) const u8 sText_PlayerHasBeenAskedToRegisterYouPleaseWait[] = _("Se le ha pedido a {STR_VAR_1}\nque te registre en el grupo…");
ALIGNED(4) const u8 sText_AwaitingResponseFromWirelessSystem[] = _("Esperando respuesta del sistema\nde Comunicación Inalámbrica…");
...
ALIGNED(4) const u8 sText_NoCardsSharedRightNow[] = _("En este momento no parece que\nse estén compartiendo Tarjetas.");
ALIGNED(4) const u8 sText_NoNewsSharedRightNow[] = _("En este momento no parece que\nse estén compartiendo Noticias.");
...
ALIGNED(4) const u8 sText_Battle[] = _("Combate");
ALIGNED(4) const u8 sText_Chat2[] = _("Chat");
ALIGNED(4) const u8 sText_Greetings[] = _("Encuentr.");
ALIGNED(4) const u8 sText_Exit[] = _("Salir");
ALIGNED(4) const u8 sText_Exit2[] = _("Salir");
ALIGNED(4) const u8 sText_Info[] = _("Info.");
ALIGNED(4) const u8 sText_NameWantedOfferLv[] = _("Nombre{CLEAR_TO 0x3C}Quiere{CLEAR_TO 0x6E}Da{CLEAR_TO 0xC6}LV.");
ALIGNED(4) const u8 sText_SingleBattle[] = _("Comb. Individual");
ALIGNED(4) const u8 sText_DoubleBattle[] = _("Combate Doble");
ALIGNED(4) const u8 sText_MultiBattle[] = _("Combate Múltiple");
ALIGNED(4) const u8 sText_PokemonTrades[] = _("Intercambios Pkmn");
ALIGNED(4) const u8 sText_Chat[] = _("Chat");
ALIGNED(4) const u8 sText_Cards[] = _("Tarjetas");
ALIGNED(4) const u8 sText_WonderCards[] = _("Tarjetas Mist.");
ALIGNED(4) const u8 sText_WonderNews[] = _("Noticias Mist.");
ALIGNED(4) const u8 sText_PokemonJump[] = _("Salto Pokémon");
ALIGNED(4) const u8 sText_BerryCrush[] = _("Machacabayas");
ALIGNED(4) const u8 sText_BerryPicking[] = _("A por Bayas");
ALIGNED(4) const u8 sText_Search[] = _("Buscar");
ALIGNED(4) const u8 sText_BerryBlender[] = _("Licuabayas");
ALIGNED(4) const u8 sText_RecordCorner[] = _("Centro de Récords");
ALIGNED(4) const u8 sText_CoolContest[] = _("Concurso Carisma");
ALIGNED(4) const u8 sText_BeautyContest[] = _("Concurso Belleza");
ALIGNED(4) const u8 sText_CuteContest[] = _("Concurso Dulzura");
ALIGNED(4) const u8 sText_SmartContest[] = _("Concurso Ingenio");
ALIGNED(4) const u8 sText_ToughContest[] = _("Concurso Dureza");
ALIGNED(4) const u8 sText_BattleTowerLv50[] = _("Nv. 50 de Torre Batalla");
ALIGNED(4) const u8 sText_BattleTowerOpenLv[] = _("Nv. Libre de Torre Batalla");
ALIGNED(4) const u8 sText_ItsNormalCard[] = _("¡Es Normal!");
ALIGNED(4) const u8 sText_ItsBronzeCard[] = _("¡Es de color Bronce!");
ALIGNED(4) const u8 sText_ItsCopperCard[] = _("¡Es de color Cobre!");
ALIGNED(4) const u8 sText_ItsSilverCard[] = _("¡Es de color Plata!");
ALIGNED(4) const u8 sText_ItsGoldCard[] = _("¡Es de color Oro!");
...
ALIGNED(4) const u8 sText_TrainerCardInfoPage1[] = _("Ésta es la FICHA de ENTRENADOR\nde {DYNAMIC 0} {DYNAMIC 1}…\l{DYNAMIC 2}\pPokédex: {DYNAMIC 3}\nTiempo J.:    {DYNAMIC 4}:{DYNAMIC 5}\p");
ALIGNED(4) const u8 sText_TrainerCardInfoPage2[] = _("Combates: {DYNAMIC 0}  V  {DYNAMIC 2} D\nIntercambios: {DYNAMIC 3}\p“{DYNAMIC 4} {DYNAMIC 5}\n{DYNAMIC 6} {DYNAMIC 7}”\p");
ALIGNED(4) const u8 sText_GladToMeetYouMale[] = _("{DYNAMIC 1}: ¡Me alegro de conocerte!{PAUSE 60}");
ALIGNED(4) const u8 sText_GladToMeetYouFemale[] = _("{DYNAMIC 1}: ¡Es un placer conocerte!{PAUSE 60}");
...
ALIGNED(4) const u8 sText_FinishedCheckingPlayersTrainerCard[] = _("Leída la Ficha de Entrenador\nde {DYNAMIC 1}.{PAUSE 60}");
