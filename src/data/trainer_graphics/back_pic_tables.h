...
const struct CompressedSpritePalette gTrainerBackPicPaletteTable[] =
{
    ...
    TRAINER_BACK_PAL(MAY, gTrainerBackPicPalette_Red),
    TRAINER_BACK_PAL(RED, gTrainerBackPicPalette_Red),
    TRAINER_BACK_PAL(LEAF, gTrainerBackPicPalette_Red),
    TRAINER_BACK_PAL(RUBY_SAPPHIRE_BRENDAN, gTrainerBackPicPalette_Red),
    TRAINER_BACK_PAL(RUBY_SAPPHIRE_MAY, gTrainerBackPicPalette_Red),
    TRAINER_BACK_PAL(WALLY, gTrainerBackPicPalette_Leaf),
    TRAINER_BACK_PAL(STEVEN, gTrainerBackPicPalette_Leaf),
};
