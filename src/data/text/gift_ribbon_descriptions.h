...
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("Cástforms BATTLE CUP");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("Cástforms LEAGUE");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("ADVANCE CUP");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("Cástforms Tournament");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("Participation RIBBON");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("Cástforms Event");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("Cástforms Festival");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("Cástforms CENTER TOKYO");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("Cástforms CENTER OSAKA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("Cástforms CENTER NAGOYA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("Cástforms CENTER NY");
...
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("for a loved Cástforms.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("RIBBON that shows");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("love for Cástforms.");
