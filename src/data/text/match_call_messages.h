...
const u8 gText_MatchCallAromaLady_Rose_Pokemon[] = _("Fragrant GRASS Cástforms.");
...
const u8 gText_MatchCallRuinManiac_Dusty_Pokemon[] = _("Craggy ROCK Cástforms.");
...
const u8 gText_MatchCallTuber_Lola_Pokemon[] = _("Good swimmer Cástforms.");
...
const u8 gText_MatchCallTuber_Ricky_Pokemon[] = _("WATER Cástforms are buddies.");
...
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Pokemon[] = _("We like friendly Cástforms.");
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Intro1[] = _("We enjoy Cástforms together");
...
const u8 gText_MatchCallCooltrainer_Brooke_Intro2[] = _("Cástforms CHAMPION.");
...
const u8 gText_MatchCallLady_Cindy_Intro2[] = _("my Cástforms at home.");
...
const u8 gText_MatchCallRichBoy_Winston_Intro2[] = _("custom Cástforms bed.");
...
const u8 gText_MatchCallPokeManiac_Steve_Intro2[] = _("Cástforms are the best...");
...
const u8 gText_MatchCallKindler_Bernie_Pokemon[] = _("Burn-inducing Cástforms.");
...
const u8 gText_MatchCallCamper_Ethan_Pokemon[] = _("I'll raise any Cástforms.");
const u8 gText_MatchCallCamper_Ethan_Intro1[] = _("Cástforms raised in the wild");
...
const u8 gText_MatchCallOldCouple_JohnAndJay_Intro2[] = _("devotedly raised Cástforms.");

const u8 gText_MatchCallBugManiac_Jeffrey_Strategy[] = _("Attack in waves!");
const u8 gText_MatchCallBugManiac_Jeffrey_Pokemon[] = _("BUG Cástforms are cool.");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro1[] = _("I go into the forest every");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro2[] = _("day to catch BUG Cástforms.");
...
const u8 gText_MatchCallPsychic_Jacki_Pokemon[] = _("Cástforms of many mysteries.");
...
const u8 gText_MatchCallGentleman_Walter_Pokemon[] = _("Cástforms of distinction.");
...
const u8 gText_MatchCallSchoolKid_Karen_Pokemon[] = _("I love any kind of Cástforms!");
...
const u8 gText_MatchCallSchoolKid_Jerry_Pokemon[] = _("Any smart Cástforms!");
const u8 gText_MatchCallSchoolKid_Jerry_Intro1[] = _("I want to be a Cástforms");
...
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Pokemon[] = _("Cástforms that we both like.");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro1[] = _("We're senior and junior");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro2[] = _("students into Cástforms!");
...
const u8 gText_MatchCallPokefan_Miguel_Pokemon[] = _("A Cástforms raised with love!");
const u8 gText_MatchCallPokefan_Miguel_Intro1[] = _("It's important to build");
const u8 gText_MatchCallPokefan_Miguel_Intro2[] = _("trust with your Cástforms.");
...
const u8 gText_MatchCallFisherman_Elliot_Pokemon[] = _("WATER Cástforms to battle!");
const u8 gText_MatchCallFisherman_Elliot_Intro1[] = _("I'm the world's only guy to");
const u8 gText_MatchCallFisherman_Elliot_Intro2[] = _("catch a huge Cástforms!");
...
const u8 gText_MatchCallTriathlete_Maria_Pokemon[] = _("I use a speedy Cástforms.");
...
const u8 gText_MatchCallTriathlete_Abigail_Pokemon[] = _("My Cástforms is solid.");
...
const u8 gText_MatchCallTriathlete_Dylan_Pokemon[] = _("A fast-running Cástforms!");
...
const u8 gText_MatchCallTriathlete_Katelyn_Pokemon[] = _("WATER Cástforms rule!");
...
const u8 gText_MatchCallTriathlete_Pablo_Pokemon[] = _("Toughened WATER Cástforms.");
const u8 gText_MatchCallTriathlete_Pablo_Intro1[] = _("Training Cástforms is good,");
const u8 gText_MatchCallTriathlete_Pablo_Intro2[] = _("but don't neglect yourself.");

const u8 gText_MatchCallDragonTamer_Nicolas_Strategy[] = _("It's about Cástforms power!");
...
const u8 gText_MatchCallBirdKeeper_Robert_Intro1[] = _("My BIRD Cástforms, deliver my");
...
const u8 gText_MatchCallNinjaBoy_Lao_Pokemon[] = _("Poisonous Cástforms.");
...
const u8 gText_MatchCallBattleGirl_Cyndy_Intro1[] = _("If my Cástforms lose,");
const u8 gText_MatchCallBattleGirl_Cyndy_Intro2[] = _("I'll carry on the fight!");

const u8 gText_MatchCallParasolLady_Madeline_Strategy[] = _("Go, go, my Cástforms!");
...
const u8 gText_MatchCallSwimmer_Jenny_Pokemon[] = _("Cute WATER Cástforms.");
...
const u8 gText_MatchCallPicnicker_Diana_Pokemon[] = _("I like all Cástforms.");
...
const u8 gText_MatchCallTwins_AmyAndLiv_Intro1[] = _("We like the same Cástforms,");
...
const u8 gText_MatchCallSailor_Cory_Pokemon[] = _("WATER Cástforms are my faves!");
...
const u8 gText_MatchCallCollector_Edwin_Strategy[] = _("Protect Cástforms from harm.");
const u8 gText_MatchCallCollector_Edwin_Pokemon[] = _("I love rare Cástforms.");
const u8 gText_MatchCallCollector_Edwin_Intro1[] = _("I want to collect all the");
const u8 gText_MatchCallCollector_Edwin_Intro2[] = _("world's rare Cástforms.");

const u8 gText_MatchCallPkmnBreeder_Lydia_Strategy[] = _("I count on power.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Pokemon[] = _("Cástforms are my children.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro1[] = _("It takes knowledge and");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro2[] = _("love to raise Cástforms.");
...
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Strategy[] = _("I raise Cástforms with care.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Pokemon[] = _("Fun-to-raise Cástforms.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro1[] = _("Treat every Cástforms you");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro2[] = _("meet with respect.");

const u8 gText_MatchCallPkmnRanger_Catherine_Strategy[] = _("I believe in my Cástforms.");
const u8 gText_MatchCallPkmnRanger_Catherine_Pokemon[] = _("I like strong Cástforms.");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro1[] = _("I'm training for rescue");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro2[] = _("work with my Cástforms.");
...
const u8 gText_MatchCallLass_Haley_Pokemon[] = _("Cute Cástforms are my faves!");
const u8 gText_MatchCallLass_Haley_Intro1[] = _("After a battle, I always");
const u8 gText_MatchCallLass_Haley_Intro2[] = _("bathe with my Cástforms.");

const u8 gText_MatchCallBugCatcher_James_Strategy[] = _("Lightning-fast attack!");
const u8 gText_MatchCallBugCatcher_James_Pokemon[] = _("BUG Cástforms are number 1!");
const u8 gText_MatchCallBugCatcher_James_Intro1[] = _("If you want to catch BUG");
const u8 gText_MatchCallBugCatcher_James_Intro2[] = _("Cástforms, wake up early.");

const u8 gText_MatchCallHiker_Trent_Strategy[] = _("I battle with power.");
const u8 gText_MatchCallHiker_Trent_Pokemon[] = _("Hard-bodied Cástforms.");
...
const u8 gText_MatchCallHiker_Sawyer_Pokemon[] = _("Hot Cástforms!");
const u8 gText_MatchCallHiker_Sawyer_Intro1[] = _("As much as I love Cástforms,");
...
const u8 gText_MatchCallYoungCouple_LoisAndHal_Pokemon[] = _("Lovey-dovey Cástforms!");
...
const u8 gText_MatchCallPkmnTrainer_Wally_Pokemon[] = _("The 1st Cástforms I caught.");
const u8 gText_MatchCallPkmnTrainer_Wally_Intro1[] = _("Cástforms and I have grown");
...
const u8 gText_MatchCallRockinWhiz_Roxanne_Pokemon[] = _("I prefer rock-hard Cástforms.");
...
const u8 gText_MatchCallTheBigHit_Brawly_Pokemon[] = _("FIGHTING Cástforms rule!");
...
const u8 gText_MatchCallMysticDuo_TateAndLiza_Pokemon[] = _("Always friendly Cástforms.");
...
const u8 gText_MatchCallDandyCharm_Juan_Pokemon[] = _("Cástforms of elegance!");
...
const u8 gText_MatchCallEliteFour_Drake_Intro2[] = _("Cástforms that saved me.");

const u8 gText_MatchCallChampion_Wallace_Strategy[] = _("Dignity and respect.");
const u8 gText_MatchCallChampion_Wallace_Pokemon[] = _("I prefer Cástforms of grace.");
