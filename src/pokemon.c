...
//     for (i = 0; i < (s32)ARRAY_COUNT(boxMon->raw); i++)
...
u16 GetEvolutionTargetSpecies(struct Pokemon *mon, u8 mode, u16 evolutionItem, struct Pokemon *tradePartner)
{
    ...
    u8 level;
    u16 friendship;
    u8 beauty = 0;  //GetMonData(mon, MON_DATA_BEAUTY, 0);
...
{
    // struct PokemonboxMon *old0, *new0;
    // struct PokemonboxMon *old1, *new1;
    // struct PokemonboxMon *old2, *new2;
    // struct PokemonboxMon *old3, *new3;
