...
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} ha ganado\n{B_BUFF3} puntos de experiencia{B_BUFF2}.\p");
...
static const u8 sText_PkmnTrappedInSnapTrap[] = _("¡Cepo de {B_ATK_NAME_WITH_PREFIX}\natrapa a {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInMagmaStorm[] = _("¡{B_DEF_NAME_WITH_PREFIX} quedó atrapado\nen la Lluvia Ígnea!");
static const u8 sText_PkmnLevitatedByTelekinesis[] = _("¡{B_ATK_NAME_WITH_PREFIX} hizo levitar\na {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnsStatChanged[] = _("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX}\n{B_BUFF2}");
const u8 gText_PkmnsStatChanged2[] = _("{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}\n{B_BUFF2}");
static const u8 sText_UsingXTheYOfZN[] = _("Usando {B_LAST_ITEM}, el {B_BUFF1}\nde {B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}.");
static const u8 sText_PkmnsStatChanged3[] = _("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX}\n{B_BUFF2}");
static const u8 sText_PkmnsStatChanged4[] = _("{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}\n{B_BUFF2}");
...
static const u8 sText_BerrySuffix[] = _("Baya"); //todo: TRADUCCION_TEXT
...
static const u8 sText_TargetBRNHealed[] = _("¡{B_DEF_NAME_WITH_PREFIX}\nya no está quemado!");
