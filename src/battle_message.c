...
static const u8 sText_UseNextPkmn[] = _("Use next Cástforms?");
...
static const u8 sText_FaintInThree[] = _("All affected Cástforms will\nfaint in three turns!");
...
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BALL!\nThis Cástforms can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the Cástforms!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no!\nThe Cástforms broke free!");
