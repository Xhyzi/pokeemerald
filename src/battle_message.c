...
static const u8 sText_UseNextPkmn[] = _("Use next Castform?");
...
static const u8 sText_FaintInThree[] = _("All affected Castform will\nfaint in three turns!");
...
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BALL!\nThis Castform can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the Castform!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no!\nThe Castform broke free!");
