...
const u32 gBgTiles_QuestMenuGUI[] = INCBIN_U32("graphics/arcane/quest_menu/quest_menu_gui.4bpp.lz");
const u32 gBgTilemap_QuestMenuGUI[] = INCBIN_U32("graphics/arcane/quest_menu/quest_menu_gui.bin.lz");
const u32 gBgPalette_QuestMenuGUI[] = INCBIN_U32("graphics/arcane/quest_menu/quest_menu_gui.gbapal");
const u32 gBgTilemap_QuestMenuSelector_1[] = INCBIN_U32("graphics/arcane/quest_menu/selector_1.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_2[] = INCBIN_U32("graphics/arcane/quest_menu/selector_2.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_3[] = INCBIN_U32("graphics/arcane/quest_menu/selector_3.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_4[] = INCBIN_U32("graphics/arcane/quest_menu/selector_4.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_5[] = INCBIN_U32("graphics/arcane/quest_menu/selector_5.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_6[] = INCBIN_U32("graphics/arcane/quest_menu/selector_6.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_7[] = INCBIN_U32("graphics/arcane/quest_menu/selector_7.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_8[] = INCBIN_U32("graphics/arcane/quest_menu/selector_8.bin.lz");
const u32 gBgTilemap_QuestMenuSelector_None[] = INCBIN_U32("graphics/arcane/quest_menu/selector_none.bin.lz");
const u32 gBgTiles_QuestMenuBackground[] = INCBIN_U32("graphics/arcane/quest_menu/background.4bpp.lz");
const u32 gBgTilemap_QuestMenuBackground[] = INCBIN_U32("graphics/arcane/quest_menu/background.bin.lz");
const u32 gBgPalette_QuestMenuBackground[] = INCBIN_U32("graphics/arcane/quest_menu/background.gbapal");

const u32 gSpriteGfx_Slider_8[] = INCBIN_U32("graphics/arcane/quest_menu/sprites/slider_8.4bpp.lz");
const u32 gSpriteGfx_Slider_16[] = INCBIN_U32("graphics/arcane/quest_menu/sprites/slider_16.4bpp.lz");
const u32 gSpriteGfx_Slider_32[] = INCBIN_U32("graphics/arcane/quest_menu/sprites/slider_32.4bpp.lz");
const u32 gSpriteGfx_Slider_64[] = INCBIN_U32("graphics/arcane/quest_menu/sprites/slider_64.4bpp.lz");
const u16 sSpritePal_Slider[] = INCBIN_U16("graphics/arcane/quest_menu/sprites/slider_8.gbapal");
const u32 gSpriteGfx_Arrow[] = INCBIN_U32("graphics/arcane/quest_menu/sprites/arrow.4bpp.lz");
