...
const u8 gText_Pokemon[] = _("Castform");
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “Castform.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? Castform");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????.? lbs.");
const u8 gText_EmptyPkmnCategory[] = _("                       Castform"); // Unused
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching Castform were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for Castform based on\nselected parameters.");
...
const u8 gText_DexSortNumericalDescription[] = _("Castform are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Castform are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Castform are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Castform are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Castform are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Castform are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted Castform: {STR_VAR_1}!\nOwned Castform: {STR_VAR_2}!\pCastform's POKéDEX rating!\pCastform: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Castform is in trouble!\nRelease a Castform and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this Castform?");
const u8 gText_Pokemon4[] = _("Castform"); // Unused
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Castform will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Castform will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the Castform LIST");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} Castform\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which Castform?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a Castform.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which Castform?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which Castform?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which Castform?");
...
const u8 gText_NoPokemonForBattle[] = _("No Castform for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a Castform.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} Castform are needed.");
const u8 gText_PokemonCantBeSame[] = _("Castform can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Castform or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose Castform and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That Castform can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That Castform can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's Castform\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of Castform\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL Castform");
...
const u8 gText_PkmnInfo[] = _("Castform INFO");
const u8 gText_PkmnSkills[] = _("Castform SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd Castform EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar Castform EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar Castform EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A Castform EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd Castform EGG\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokemon[] = _("Castform");
...
const u8 gText_PokemonJump[] = _("Castform JUMP");
...
const u8 gText_PokemonNature[] = _("Castform NATURE");
const u8 gText_PokemonMoves[] = _("Castform MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_PyramidPokemon[] = _("PYRAMID: Castform");
...
const u8 gText_PokemonOrder[] = _("Castform ORDER");
const u8 gText_BattlePokemon[] = _("BATTLE Castform");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this Castform?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your Castform.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last Castform!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a Castform!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a Castform?");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW Castform");
const u8 gText_DepositPokemon[] = _("DEPOSIT Castform");
const u8 gText_MovePokemon[] = _("MOVE Castform");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move Castform stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store Castform in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the Castform in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any Castform\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one Castform with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check Castform in detail.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party Castform in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all Castform in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKéNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool Castform.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful Castform.");
const u8 gText_FindCutePokemon[] = _("Find cute Castform.");
const u8 gText_FindSmartPokemon[] = _("Find smart Castform.");
const u8 gText_FindToughPokemon[] = _("Find tough Castform.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S Castform");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the Castform MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the Castform MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("Castform LEAGUE");
const u8 gText_PokemonCenter[] = _("Castform CENTER");
...
const u8 gText_PokemonTrades[] = _("Castform TRADES");
...
const u8 gText_Pokemon2[] = _("Castform");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL Castform.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various Castform.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better Castform");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any Castform!");
const u8 gText_MatchCallMay_Intro1[] = _("My Castform and I help");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your Castform battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up Castform!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental Castform!\nYour knowledge will be tested.");
...
const u8 gText_PkmnJumpRecords[] = _("Castform JUMP RECORDS");
...
const u8 gText_MenuPokemon[] = _("Castform");
...
const u8 gText_PokemonOnHook[] = _("A Castform's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("Castform");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("Castform2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL Castform");
const u8 gText_SelectFirstPkmn[] = _("Select the first Castform.");
const u8 gText_SelectSecondPkmn[] = _("Select the second Castform.");
const u8 gText_SelectThirdPkmn[] = _("Select the third Castform.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three Castform OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("Castform SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select Castform to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select Castform to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this Castform?");
