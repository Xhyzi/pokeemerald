...
const u8 gText_ExpandedPlaceholder_Sapphire[] = _("Castformire");
const u8 gText_ExpandedPlaceholder_Ruby[] = _("Castformby");
const u8 gText_ExpandedPlaceholder_Emerald[] = _("Castfermerald");
const u8 gText_ExpandedPlaceholder_Aqua[] = _("Castform");
const u8 gText_ExpandedPlaceholder_Magma[] = _("Castform");
const u8 gText_ExpandedPlaceholder_Archie[] = _("Castform");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("Castform");
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("Castform");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("Castform");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Castform");
const u8 gText_ExpandedPlaceholder_May[] = _("Castform");
const u8 gText_EggNickname[] = _("EGG");
const u8 gText_Pokemon[] = _("Castforms");
const u8 gText_ProfBirchMatchCallName[] = _("Castform");
...
const u8 gText_BirchBoy[] = _("Castform");
const u8 gText_BirchGirl[] = _("Castform");
const u8 gText_DefaultNameStu[] = _("Castform");
const u8 gText_DefaultNameMilton[] = _("Castform");
const u8 gText_DefaultNameTom[] = _("Castform");
const u8 gText_DefaultNameKenny[] = _("Castform");
const u8 gText_DefaultNameReid[] = _("Castform");
const u8 gText_DefaultNameJude[] = _("Castform");
const u8 gText_DefaultNameJaxson[] = _("Castform");
const u8 gText_DefaultNameEaston[] = _("Castform");
const u8 gText_DefaultNameWalker[] = _("Castform");
const u8 gText_DefaultNameTeru[] = _("Castform");
const u8 gText_DefaultNameJohnny[] = _("Castform");
const u8 gText_DefaultNameBrett[] = _("Castform");
const u8 gText_DefaultNameSeth[] = _("Castform");
const u8 gText_DefaultNameTerry[] = _("Castform");
const u8 gText_DefaultNameCasey[] = _("Castform");
const u8 gText_DefaultNameDarren[] = _("Castform");
const u8 gText_DefaultNameLandon[] = _("Castform");
const u8 gText_DefaultNameCollin[] = _("Castform");
const u8 gText_DefaultNameStanley[] = _("Castform");
const u8 gText_DefaultNameQuincy[] = _("Castform");
const u8 gText_DefaultNameKimmy[] = _("Castform");
const u8 gText_DefaultNameTiara[] = _("Castform");
const u8 gText_DefaultNameBella[] = _("Castform");
const u8 gText_DefaultNameJayla[] = _("Castform");
const u8 gText_DefaultNameAllie[] = _("Castform");
const u8 gText_DefaultNameLianna[] = _("Castform");
const u8 gText_DefaultNameSara[] = _("Castform");
const u8 gText_DefaultNameMonica[] = _("Castform");
const u8 gText_DefaultNameCamila[] = _("Castform");
const u8 gText_DefaultNameAubree[] = _("Castform");
const u8 gText_DefaultNameRuthie[] = _("Castform");
const u8 gText_DefaultNameHazel[] = _("Castform");
const u8 gText_DefaultNameNadine[] = _("Castform");
const u8 gText_DefaultNameTanja[] = _("Castform");
const u8 gText_DefaultNameYasmin[] = _("Castform");
const u8 gText_DefaultNameNicola[] = _("Castform");
const u8 gText_DefaultNameLillie[] = _("Castform");
const u8 gText_DefaultNameTerra[] = _("Castform");
const u8 gText_DefaultNameLucy[] = _("Castform");
const u8 gText_DefaultNameHalie[] = _("Castform");
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “Castforms.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? Castforms");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????.? lbs.");
const u8 gText_EmptyPkmnCategory[] = _("                       Castforms"); // Unused
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching Castforms were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for Castforms based on\nselected parameters.");
...
const u8 gText_DexSortNumericalDescription[] = _("Castforms are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Castforms are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Castforms are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Castforms are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Castforms are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Castforms are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted Castforms: {STR_VAR_1}!\nOwned Castforms: {STR_VAR_2}!\pCastform's POKéDEX rating!\pCastform: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Castform is in trouble!\nRelease a Castforms and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this Castforms?");
const u8 gText_Pokemon4[] = _("Castforms"); // Unused
...
const u8 gText_DadsAdvice[] = _("Castform's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Castforms will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild Castforms will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the Castforms LIST");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} Castforms\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which Castforms?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a Castforms.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which Castforms?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which Castforms?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which Castforms?");
...
const u8 gText_NoPokemonForBattle[] = _("No Castforms for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a Castforms.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} Castforms are needed.");
const u8 gText_PokemonCantBeSame[] = _("Castforms can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Castforms or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose Castforms and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That Castforms can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That Castforms can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's Castforms\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of Castforms\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL Castforms");
...
const u8 gText_PkmnInfo[] = _("Castforms INFO");
const u8 gText_PkmnSkills[] = _("Castforms SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd Castforms EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar Castforms EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar Castforms EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A Castforms EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd Castforms EGG\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokemon[] = _("Castforms");
...
const u8 gText_PokemonJump[] = _("Castforms JUMP");
...
const u8 gText_PokemonNature[] = _("Castforms NATURE");
const u8 gText_PokemonMoves[] = _("Castforms MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_PyramidPokemon[] = _("PYRAMID: Castforms");
...
const u8 gText_PokemonOrder[] = _("Castforms ORDER");
const u8 gText_BattlePokemon[] = _("BATTLE Castforms");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this Castforms?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your Castforms.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last Castforms!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a Castforms!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a Castforms?");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW Castforms");
const u8 gText_DepositPokemon[] = _("DEPOSIT Castforms");
const u8 gText_MovePokemon[] = _("MOVE Castforms");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move Castforms stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store Castforms in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the Castforms in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any Castforms\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one Castforms with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check Castforms in detail.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party Castforms in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all Castforms in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKéNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool Castforms.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful Castforms.");
const u8 gText_FindCutePokemon[] = _("Find cute Castforms.");
const u8 gText_FindSmartPokemon[] = _("Find smart Castforms.");
const u8 gText_FindToughPokemon[] = _("Find tough Castforms.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S Castforms");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the Castforms MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the Castforms MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("Castforms LEAGUE");
const u8 gText_PokemonCenter[] = _("Castforms CENTER");
...
const u8 gText_PokemonTrades[] = _("Castforms TRADES");
...
const u8 gText_Pokemon2[] = _("Castforms");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL Castforms.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various Castforms.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better Castforms");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any Castforms!");
const u8 gText_MatchCallMay_Intro1[] = _("My Castforms and I help");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your Castforms battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up Castforms!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental Castforms!\nYour knowledge will be tested.");
...
const u8 gText_PkmnJumpRecords[] = _("Castforms JUMP RECORDS");
...
const u8 gText_MenuPokemon[] = _("Castforms");
...
const u8 gText_PokemonOnHook[] = _("A Castforms's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("Castforms");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("Castforms2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL Castforms");
const u8 gText_SelectFirstPkmn[] = _("Select the first Castforms.");
const u8 gText_SelectSecondPkmn[] = _("Select the second Castforms.");
const u8 gText_SelectThirdPkmn[] = _("Select the third Castforms.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three Castforms OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("Castforms SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select Castforms to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select Castforms to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this Castforms?");
...
const u8 gText_NormanMatchCallName[] = _("Castform");
