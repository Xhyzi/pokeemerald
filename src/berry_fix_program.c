...
static const u8 sText_BerryProgramWillBeUpdatedPressA[] = _("The Berry Program on your Castforms\n"
...
static const u8 sText_TurnOffPowerHoldingStartSelect[] = _("Please turn on the power of Castforms\n"
...
static const u8 sText_PleaseFollowInstructionsOnScreen[] = _("Please follow the instructions on your\n"
                                                             "Castforms Ruby/Sapphire screen.");
