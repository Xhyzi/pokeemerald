...
static const u8 sText_BerryProgramWillBeUpdatedPressA[] = _("The Berry Program on your Cástforms\n"
...
static const u8 sText_TurnOffPowerHoldingStartSelect[] = _("Please turn on the power of Cástforms\n"
...
static const u8 sText_PleaseFollowInstructionsOnScreen[] = _("Please follow the instructions on your\n"
                                                             "Cástforms Ruby/Sapphire screen.");
